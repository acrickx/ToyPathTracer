...
public:
	...
	//methods
	Material() { albedo = Vec3f(0.5f, 0.5f, 0.5f); diffuse = 1.f; roughness = 0.0f; metallic = 0.0f; }
	...
	Material(Vec3f _albedo) : albedo(_albedo) { diffuse = 1.f; roughness = 1.0f; metallic = 0.0f; };
