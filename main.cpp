...
int main(int argc, char* argv[])
{
    ...
    //Scene scene(cam, std::vector<Mesh> {plane,model}, lights);
    ...
    auto chrono2 = duration_cast<milliseconds>(t4 - t3);
    std::cout << "duration rendering : " << chrono2.count() * 0.001f << std::endl;
